    ...
    <section className="py-16 lg:py-20 bg-background relative overflow-hidden">
      <div className="container mx-auto px-6 relative">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-card border border-border mb-5">
            <Sparkles className="h-4 w-4 text-orange" />
            <span className="text-sm text-muted-foreground font-medium font-body">Our Supporters</span>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-card rounded-2xl p-6 md:p-8 shadow-lg border border-border relative overflow-hidden">
