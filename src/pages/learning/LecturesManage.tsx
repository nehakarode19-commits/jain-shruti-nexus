...
const LecturesManage = () => {
  ...
  return (
    <LearningLayout title="Lecture Management">
      <div className="space-y-6">
        ...
        {selectedCourseId && (
          <>
            {/* Course Info */}
            <div className="bg-gradient-to-r from-primary/10 to-orange/10 rounded-xl p-4 border border-border flex items-center gap-4">
            ...
            <Tabs defaultValue="lectures" className="space-y-6">
              ...
              <TabsContent value="lectures" className="space-y-4">
                <div className="flex justify-end">
                  <Button onClick={() => { resetLectureForm(); setIsLectureDialogOpen(true); }} className="gap-2">
                      ...
                      {lecturesLoading ? (
                        ...
                        lectures.map((lecture) => (
                          <TableRow key={lecture.id}>
                            ...
                            <TableCell>{lecture.duration_minutes ? `${lecture.duration_minutes} min` : "-"}</TableCell>
                            <TableCell>
              ...
              <TabsContent value="materials" className="space-y-4">
                <div className="flex justify-end">
                  <Button onClick={() => { resetMaterialForm(); setIsMaterialDialogOpen(true); }} className="gap-2">
                      ...
                      {materialsLoading ? (
                        ...
                        <TableRow>
                          <TableCell colSpan={5} className="text-center py-8 text-muted-foreground">
                            No materials yet. Add study materials.
                          </TableCell>
                        </TableRow>
                      ) : (
          ...
          <DialogContent className="max-w-lg">
            ...
            <div className="space-y-4 py-4">
              ...
              <div>
                ...
                <Select value={materialForm.lecture_id} onValueChange={(v) => setMaterialForm({ ...materialForm, lecture_id: v })}>
