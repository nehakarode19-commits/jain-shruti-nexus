...
const sampleResults = [
  ...
  {
    id: 4,
    title: "Complete Works of Gurudev Muni Jambuvijayaji Maharaj Saheb",
    snippet: "Comprehensive collection of scholarly works, edited manuscripts, and research notes by the revered Gurudev Muni Jambuvijayaji Maharaj Saheb, pioneer in Jain manuscript preservation.",
